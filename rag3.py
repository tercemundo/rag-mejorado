...
def generate_response(query):
    # Si el usuario activó la opción de usar solo el conocimiento del modelo, ignoramos los PDFs
...
with st.sidebar:
    ...
    if st.session_state.api_key_validated:
        ...
        # Opción booleana para usar solo el conocimiento del modelo
        ...
        st.session_state.use_only_model_knowledge = use_only_model
        
        # Mostrar configuración de relevancia solo si no se está usando exclusivamente el modelo
